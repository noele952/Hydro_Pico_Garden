...
<html lang=\"en\">
  <head>
    ...
    <title>Raspberry Pi Pico W BME280 Weather Station</title>
    <link
  ...
  <body>
    <div class=\"sidebar\">
      <div class=\"logo-details\">
        ...
        <span class=\"logo_name\">hydropi</span>
      </div>
      <ul class=\"nav-links\">
        <li>
          <a href=\"#\" class=\"active\">
    ...
    <section class=\"home-section\">
      <nav>
        <div class=\"sidebar-button\">
          ...
          <span class=\"dashboard\">Raspberry Pi Pico W: Hydroponic Garden</span>
        </div>
      </nav>
        ...
        <div class=\"overview-boxes\">
          ...
          <div class=\"box\">
            <div class=\"right-side\">
              ...
              <div class=\"number\" id=\"humidity\"></div>
            </div>
            <i class=\"bx bxs-droplet-half readings two\"></i>
          </div>
          <div class=\"box\">
            <div class=\"right-side\">
              <div class=\"box-topic\">Pressure</div>
              <div class=\"number\" id=\"pressure\"></div>
            </div>
            <i class=\"bx bxs-tachometer readings three\"></i>
          </div>
          <div class=\"box\">
            <div class=\"right-side\">
              <div class=\"box-topic\">Water Temp</div>
              <div class=\"number\" id=\"water_temp\"></div>
            </div>
        ...
        <div class=\"graph-box\">
          <div class=\"history-charts\">
            ...
            <div class=\"history-details\">
              ...
              <div class=\"history-col-item\">
                ...
                <div id=\"water_temp-history\" class=\"history-divs\"></div>
              </div>
            </div>
          </div>
          <div class=\"gaugeCharts\">
            ...
            <div class=\"gauge-list\">
              <div class=\"gauge-box\"><div id=\"temperature-gauge\"></div></div>
              <div class=\"gauge-box\"><div id=\"humidity-gauge\"></div></div>
              <div class=\"gauge-box\"><div id=\"pressure-gauge\"></div></div>
              <div class=\"gauge-box\"><div id=\"water_temp-gauge\"></div></div>
            </div>
          </div>
        </div>
      </div>
